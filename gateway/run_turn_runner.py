...
class TurnRunner:
    ...
    def run_sync(self):
        ...
        usage = {
            ...
            # Local extension: expose the provider that actually served the turn
            # (fallback switches update agent.provider in place, so the footer
            # reflects the live backend, not the configured primary).
